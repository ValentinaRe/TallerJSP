...
public class UsuarioDAO {
	public static Usuario loadUsuarioByORMID(int uid) throws PersistentException {
		try {
			PersistentSession session = orm.Taller1MagisterInformaticaPersistentManager.instance().getSession();
			return loadUsuarioByORMID(session, uid);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Usuario getUsuarioByORMID(int uid) throws PersistentException {
		try {
			PersistentSession session = orm.Taller1MagisterInformaticaPersistentManager.instance().getSession();
			return getUsuarioByORMID(session, uid);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(int uid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.Taller1MagisterInformaticaPersistentManager.instance().getSession();
			return loadUsuarioByORMID(session, uid, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(int uid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.Taller1MagisterInformaticaPersistentManager.instance().getSession();
			return getUsuarioByORMID(session, uid, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int uid) throws PersistentException {
		try {
			return (Usuario) session.load(orm.Usuario.class, new Integer(uid));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int uid) throws PersistentException {
		try {
			return (Usuario) session.get(orm.Usuario.class, new Integer(uid));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int uid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.load(orm.Usuario.class, new Integer(uid), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int uid, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.get(orm.Usuario.class, new Integer(uid), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(orm.Usuario usuario) throws PersistentException {
		try {
			orm.Taller1MagisterInformaticaPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Usuario usuario) throws PersistentException {
		try {
			orm.Taller1MagisterInformaticaPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Usuario usuario) throws PersistentException {
		try {
			orm.Taller1MagisterInformaticaPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Usuario usuario) throws PersistentException {
		try {
			orm.Taller1MagisterInformaticaPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
